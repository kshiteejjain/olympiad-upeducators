            ...
            <div className='container-wrapper'>
                ...
                <div className='faq'>
                    <details>
                        ...
                        <p>No additional fee payments are required for attending the Live Training Sessions. These enriching educational experiences are included in the Registration Fee of Rs. 369/- without any hidden or extra charges.</p>
                    </details>
                    ...
                    <details>
                        ...
                        <p>You can attempt this test from your Windows Desktop or Laptop with a working webcam.</p>
                    </details>
                    ...
                    <details>
                        ...
                        <p>upEducators, a distinguished Google For Education Partner Company, is proudly organizing this Maths Teachers’ Olympiad. We are dedicated to empowering educators with innovative teaching methodologies and achieving excellence. For more insights into our mission and initiatives, please <a href="https://www.upeducators.com/about" target='_blank'>click here</a>.</p>
                    </details>

                    <details>
                        <summary>Can I cancel my registration or request a refund?</summary>
                    ...
                    <details>
                        ...
                        <p>Please mail your query to <a href="mailto:olympiad@upeducators.com">olympiad@upeducators.com</a> and you will get a reply in your mail within 2 working days.</p>
                    </details>
                    ...
                    <details>
                        ...
                        <p>You need to mail at <a href="mailto:olympiad@upeducators.com">olympiad@upeducators.com</a> before 31st August 2024 along with the payment receipt. After the deadline, your details will not be changed in any case.</p>
                    </details>
                    ...
                    <details>
                        <summary>How will the Top 3 Winners be Decided?</summary>
                        <ul>
                            <li>All the Participants will attempt the Olympiad exam (Phase 1).</li>
                            <li>Top 200 participants will then get selected for the Maths Educator Excellence Award.</li>
                            <li>The selected educators need to submit: A Lesson Plan using Innovative Teaching Practices in Mathematics Education. A video of 3-5 minutes explaining the lesson.</li>
                            ...
                            <li>After the evaluation:One winner will be selected from each grade level (e.g., Grade 1 to 5, Grade 6 to 10, Grade 11 and above)</li>
