    ...
    const faqs: FAQItem[] = [
        {
            ...
            questions: [
                ...
                },
                {
                    ...
                    answer: 'You need to mail at olympiad@upeducators.com before 2nd March 2025 along with the payment receipt. After the deadline, your details will not be changed in any case.',
                }
            ],
        },
        {
