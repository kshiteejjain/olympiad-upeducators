    ...
    const faqs: FAQItem[] = [
        {
            ...
            questions: [
                ...
                },
                {
                    ...
                    answer: 'You need to mail at olympiad@upeducators.com atleast one week before along with the payment receipt. After the deadline, your details will not be changed in any case.',
                }
            ],
        },
        {
