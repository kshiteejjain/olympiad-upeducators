    ...
    return (
        <div className="content">
            ...
            <div className="exam-rules">
                ...
                <p><strong>2. Exam Start Time</strong>: Click on 'Start Final Exam' button on 22 March, 2025 between 5 pm and 7 pm IST to start the Olympiad Exam. Do not attempt to start the exam before this time.</p>
