...
const TeachersData = [{
    name: 'Ms. Ankita Shaw',
    data: 'Transforming English Education with Artificial Intelligence',
    image: AnkitaShawImage
},
{
    name: 'Ms. Nishita Israni',
    data: 'Innovative Teaching Strategies in English Language Education',
    image: NishitaImage
},
{
...
},
{
    ...
    data: 'Using Technology for Enhanced Language Learning',
    image: LopamudraImage
},
{
    name: 'Ms. Manju Borkar',
    data: 'Social Emotional Learning: Fostering Emotional Wellness',
    image: ManjuImage
},
{
