                ...
                <>
                    {showCamera && !capturingIdProof && (
                        <div className='live-camera'>
                            ...
                            <div className='live-camera-cta'>
                                {!photoCaptured && (
                                    <Button type="button" title='Capture Photo Demo Exam' onClick={capturePhoto} />
                                )}
                            </div>
                        </div>
                    )}
                    ...
                    {photoSrc && !capturingIdProof && (
                        <div className='captured-photo'>
                            <p>Captured Photo</p>
                            <img src={photoSrc} alt="Captured Photo Demo Exam" />
                            <div className='live-camera-cta'>
                                {photoCaptured && (
                                    <Button type="button" isSecondary title='Retake Photo' onClick={handleRetakePhoto} />
                                )}
                                <Button type="button" title="Next - Demo Exam" onClick={handleNextClick} />
                            </div>
                        </div>
                    )}
                    ...
                    {capturingIdProof && showCamera && (
                        <div className='live-camera'>
                            ...
                            <div className='live-camera-cta'>
                                {!idProofCaptured && (
                                    <Button type="button" title='Capture ID Proof - Demo Exam' onClick={captureIdProof} />
                                )}
                            </div>
                        </div>
                    )}
                    ...
                    {idProofSrc && (
                        <div className='captured-photo'>
                            ...
                            <div className='live-camera-cta'>
                                {idProofCaptured && (
                                    <Button type="button" isSecondary title='Retake ID' onClick={handleRetakeIdProof} />
                                )}
                                <Button type="button" title="Start Demo Exam" onClick={openExamWindow} />
                            </div>
...
export default CapturePhotoDemoExam;
