...
const AboutOlympiad = () => {
    return (
        <div className='content'>
            ...
            <p><strong>Shaping the Future of Education with Innovation and Excellence</strong></p>
            <p>The International Maths Teachers' Olympiad not only recognizes outstanding educators but also serves as a catalyst for advancing mathematics education. It represents a pioneering initiative to empower educators, enhancing their ability to inspire and engage future generations. By promoting a deeper understanding of mathematical concepts and innovative teaching methods, we aim to elevate the quality of mathematics education both in India and around the world.</p>
            <p>Join us as we celebrate excellence and foster a lifelong passion for mathematics in educators and their students alike!</p>
            <p><strong>A Two-Phase Olympiad for a Comprehensive Assessment</strong></p>
            <div className='faq'>
                <details>
                    <summary>Phase 1: The Instructional Proficiency Test</summary>
                    <ul className='list'>
                        ...
                        <li>Outcome <span>The Top 200 scorers will advance to the Maths Educator Excellence Award</span></li>
                ...
                <details>
                    <summary>Phase 2: Maths Educator Excellence Award</summary>
                    <ul className='list'>
                        ...
                        <li><strong>Rewards for all the selected participants:</strong>
                        ...
                        <li><strong>Rewards for the Top 3 Winners:</strong>
